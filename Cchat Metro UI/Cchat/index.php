...
text-align: center;
cursor: pointer;
animation: example3 1s ease; animation-iteration-count: infinite;
display:flex;
align-items: center;
justify-content: center;
-webkit-tap-highlight-color: rgba(0, 0, 0, 0);
...
to {left:0px;}
 ...
 .form input[type='email']::placeholder, .form input[type="text"]::placeholder, .form input[type='password']::placeholder {
font-weight: normal;
font-size: medium;
}
.form #arrow {
...
animation: example33 1s ease-in-out 0s forwards;
}
...
animation: example33 1s ease-in-out 0.5s forwards;
}
...
animation: example33 1s ease-in-out 1s forwards;
}

#c4 {
left: 60px; top: 120px;
animation: example33 1s ease-in-out 1.5s forwards;
}

@keyframes example33 {
from { transform: scale(0); opacity: 0.0;}
...
<body>
<audio src="bg/3.mp3" id="nice" style="visibility: hidden;"></audio>
<div class="outer1" id="outer1">
<h1>Welcome to Messenger</h1> <br> <br><br>
<img src="bg/2.png" style="animation: example5 1s ease-in-out; box-shadow: none;"> 
<div class="s1" id="c1"></div>
<div class="s1" id="c2"></div>
<div class="s1" id="c3"></div>
<div class="s1" id="c4"></div>
<br> <br> <br> <br> 
<div id="arrow" onclick="s1('outer2');" ontouchstart="window.navigator.vibrate(14);"> ❤️ </div>
</div>

<div class="outer1" id="outer2">
<h1>Made with Care</h1> <br>
<img src="bg/3.png" id="care" style="transform: rotate(-5deg);"> <br> <br>
<div id="arrow" onclick="s1('outer3');" ontouchstart="window.navigator.vibrate(14);"> 🌟 </div>
</div>

<div class="outer1" id="outer3">
<h1>What's your name? </h1> <br>
<img src="bg/5.png" id="login1" style="box-shadow: none;"> <br><br>
<div id="arrow" onclick="s1('outer4');" ontouchstart="window.navigator.vibrate(14);"> ✒️ </div>
</div>

<div class="outer1" id="outer4" style="position: relative;">
<script src="bg/gsap.min.js"></script>
...
<input type="text" id="email" class="email" maxlength="256" placeholder="Name" spellcheck="false" autocomplete="off"/>
<span class="indicator"></span>
</div>
<div class="inputGroup inputGroup2">
<input type="password" pattern="[0-9]*" inputmode="numeric" id="password" class="password" placeholder="Password"/>
</div>
<div class="inputGroup inputGroup3">
<div id="arrow" onclick="othen();" ontouchstart="window.navigator.vibrate(14);" style="box-shadow: 1px 1px 5px grey;animation:none;"> > </div>
</div>	
</div>
</div>
<script>
...
function othen(){
    if(document.getElementById('password').value=="9474"){
                location.href='home.php?q='+document.getElementById('email').value;     
                }
    else {
        document.getElementById('password').value = "";
        document.getElementById('form').style.animation="example6 0.1s linear 5";      
        setTimeout(function naa(){document.getElementById('form').style.animation="";}, 1000);
}
}


window.onload = function(){s1('outer1');}
...
document.getElementById('care').style.animation="example 3s ease-in-out infinite";
}
if(x1 == "outer3") {
document.getElementById('login1').style.animation="example5 1s ease-in-out";
document.getElementById('login2').style.animation="example5 1s ease-in-out";
}
